...
{
    public partial class AddAllstarfull
    {
        [Inject]
        ...
        {
            allstarfull = new TestingRadzenBlazorApp.Models.Baseball.Allstarfull();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BaseballService.CreateAllstarfull(allstarfull);
