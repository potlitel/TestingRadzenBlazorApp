...
{
    public partial class AddAwardssharemanager
    {
        [Inject]
        ...
        {
            awardssharemanager = new TestingRadzenBlazorApp.Models.Baseball.Awardssharemanager();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BaseballService.CreateAwardssharemanager(awardssharemanager);
