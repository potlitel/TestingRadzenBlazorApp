...
{
    public partial class AddBattingpost
    {
        [Inject]
        ...
        {
            battingpost = new TestingRadzenBlazorApp.Models.Baseball.Battingpost();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BaseballService.CreateBattingpost(battingpost);
