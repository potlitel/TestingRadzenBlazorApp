...
{
    public partial class AddSchoolsplayer
    {
        [Inject]
        ...
        {
            schoolsplayer = new TestingRadzenBlazorApp.Models.Baseball.Schoolsplayer();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BaseballService.CreateSchoolsplayer(schoolsplayer);
