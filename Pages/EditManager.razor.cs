...
namespace TestingRadzenBlazorApp.Pages
{
    public partial class EditManager
    {
        ...
        {
            manager = await BaseballService.GetManagerByYearIdAndTeamIdAndInseason(yearID, teamID, inseason);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BaseballService.UpdateManager(yearID, teamID, inseason, manager);
