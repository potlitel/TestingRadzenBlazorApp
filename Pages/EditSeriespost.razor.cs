...
{
    public partial class EditSeriespost
    {
        [Inject]
        ...
        {
            seriespost = await BaseballService.GetSeriespostByYearIdAndRound(yearID, round);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await BaseballService.UpdateSeriespost(yearID, round, seriespost);
